...
import { Flag, AlertTriangle, Check, Shield, User, Download, Ban, AlertCircle } from 'lucide-react';
    ...
    <div style={{ paddingBottom: '64px', minHeight: 'calc(100vh - 64px)', display: 'flex', flexDirection: 'column' }}>
      ...
      <div className="flex-between" style={{ marginBottom: '24px' }}>
        <div>
          ...
          <p style={{ color: 'var(--text-secondary)' }}>Review flagged messages and reported conversations between users</p>
        </div>
      </div>
              ...
              <div style={{ flex: 1, overflowY: 'auto', padding: '24px', backgroundColor: 'var(--bg-primary)' }}>
                {activeReport.messages && activeReport.messages.length > 0 ? (
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
                    {activeReport.messages.map((msg, idx) => {
                  ...
                  <div className="flex-center" style={{ height: '100%', color: 'var(--text-secondary)' }}>
                    No messages context available for this report.
                  </div>
                )}
              </div>
